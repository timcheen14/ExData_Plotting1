...
## 5. Plot a time series of Global Active Power and the date-time series created
##    step 4
...
#Plot the timeseries of Global Active Power
with(hpc_subset, plot(dtseries, Global_active_power,
                      type = "l",
                      xlab = "",
