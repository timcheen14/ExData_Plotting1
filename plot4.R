...
## 5. Plot a time series for each global activer power, energy submetering 
##    values, global reactive power, voltage vs the date-time series created 
##    in step 4
...
#set the plot workspace to 2 x 2
par(mfcol = c(2,2))

#Plot the timeseries of Global Active Power, energy submetering, voltage and 
#global reactive power

with(hpc_subset, {
  plot(dtseries, Global_active_power,
                 type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")

  plot(dtseries, Sub_metering_1,
  ...
  plot(dtseries, Voltage,
       type = "l", xlab = "datetime", ylab = "Voltage")
  
  plot(dtseries, Global_reactive_power,
